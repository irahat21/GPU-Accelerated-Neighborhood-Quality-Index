...
DATASETS = {
    ...
    "water_sampling_sites": "https://data.cityofnewyork.us/api/views/bkwf-xfky/files/e93e4856-95f7-48d4-b4c0-fa54989cdbfc?download=true&filename=OpenData_Distribution_Water_Quality_Sampling_Sites_Updated_2021-0618.xlsx",
}
...
for name, url in DATASETS.items():
    ...
    print(f"{name}.csv has finished downloading")